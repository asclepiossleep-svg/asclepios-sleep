 ...
 * site (owner-approved issue #45 reference design's "botanical accents").
 * Independent copy of apps/web's component — apps/health-web is its own
 * deployment and does not import across the workspace boundary. Purely
